...
async def rerank_results(query: str, docs: list, top_k: int = 3) -> list:
    if not docs: return []
...
async def retrieve_text(query: str, top_k: int = 3, mata_pelajaran: Optional[str] = None, kelas: Optional[int] = None) -> list:
    """
